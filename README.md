...
![updatett demo](assets/updatett-demo.gif)
## Currently
Updates uv, Claude CLI, Gemini CLI, Codex, Wrangler, Pyright, TypeScript LS. Shows before/after versions and skips tools that are already up to date.
